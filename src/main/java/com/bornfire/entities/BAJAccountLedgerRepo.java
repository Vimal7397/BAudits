...
public interface BAJAccountLedgerRepo extends JpaRepository<BAJAccountLedger_Entity, String>{
    ...
    @Query(value = "SELECT " +
        ...
        "WHERE TO_DATE('31-03-2026', 'DD-MM-YYYY') BETWEEN dv.TRAN_DATE AND dv.END_TRAN_DATE " +
        "AND cv.del_flg = 'N' " +
    ...
    @Query(value =
		    ...
		    "       a.ACCT_CRNCY, " +
		    "       a.ACCT_STATUS, " +
		    "       DECODE(b.TRAN_DATE, TO_DATE('31-03-2026', 'DD-MM-YYYY'), b.TRAN_DR_BAL, 0) AS DR, " +
		    "       DECODE(b.TRAN_DATE, TO_DATE('31-03-2026', 'DD-MM-YYYY'), b.TRAN_CR_BAL, 0) AS CR, " +
		    "       b.TRAN_DATE_BAL, " +
		    "       b.TRAN_TOT_NET " +
		    "FROM DAB_VIEW b, " +
		    "     COA_VIEW a " +
		    ...
		    "  AND TO_DATE('31-03-2026', 'DD-MM-YYYY') BETWEEN b.TRAN_DATE AND b.END_TRAN_DATE " +
